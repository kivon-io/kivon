...
const EarnedPoints = ({ amount }: { amount: number }) => {
  ...
  return (
    <div className='flex gap-2 border border-emerald-200 dark:border-emerald-800 rounded-lg p-2.5 relative overflow-hidden bg-emerald-500/30 dark:bg-emerald-500/20 w-full'>
