...
export interface ApiServiceService extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    heading: Schema.Attribute.String;
    live_support_card: Schema.Attribute.Component<'cards.live-support', false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::service.service'
    > &
      Schema.Attribute.Private;
    market_rate_card: Schema.Attribute.Component<'cards.market-rate', false>;
    publishedAt: Schema.Attribute.DateTime;
    secure_card: Schema.Attribute.Component<'cards.secure-card', false>;
    sub_heading: Schema.Attribute.Text;
    transaction_card: Schema.Attribute.Component<
...
export interface ApiTradeCoinTradeCoin extends Struct.CollectionTypeSchema {
  collectionName: 'trade_coins';
  info: {
    displayName: 'TradeCoin';
    pluralName: 'trade-coins';
    singularName: 'trade-coin';
  };
  options: {
    draftAndPublish: true;
  };
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::trade-coin.trade-coin': ApiTradeCoinTradeCoin;
